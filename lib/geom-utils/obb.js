...
export default class obb {
   ...
   * @param {number} w the half of obb width
   * @param {number} h the half of obb height
   * @param {number} l the half of obb length
   ...
   * @return {obb}
   */
  static create(px, py, pz, w, h, l, ox_1, ox_2, ox_3, oy_1, oy_2, oy_3, oz_1, oz_2, oz_3) {
    return new obb(px, py, pz, w, h, l, ox_1, ox_2, ox_3, oy_1, oy_2, oy_3, oz_1, oz_2, oz_3);
  }
