  ...
  constructor(view, opts) {
    ...
    this._mousemoveHandle = event => {
      ...
      if (this._pointerLocked) {
        ...
        this._mouse.x = this._view._calcOffsetX(event.clientX, event.clientY);
        this._mouse.y = this._view._calcOffsetY(event.clientX, event.clientY);
      }
    };
    ...
    this._mouseupHandle = event => {
      ...
      this._mouse.dx = event.movementX;
      this._mouse.dy = event.movementY;
      this._mouse.prevX = this._mouse.x = this._view._calcOffsetX(event.clientX, event.clientY);
      this._mouse.prevY = this._mouse.y = this._view._calcOffsetY(event.clientX, event.clientY);
    ...
    this._touchstartHandle = event => {
      ...
      for (let i = 0; i < event.changedTouches.length; i++) {
        ...
        touch.x = this._view._calcOffsetX(changedTouch.clientX, changedTouch.clientY);
        touch.y = this._view._calcOffsetY(changedTouch.clientX, changedTouch.clientY);
        touch.dx = 0;
        touch.dy = 0;
        touch.prevX = 0;
        touch.prevY = 0;
      ...
      for (let i = 0; i < this._touches.length; i++) {
        for (let j = 0; j < event.changedTouches.length; j++) {
          ...
          if (touch.id === changedTouch.identifier) {
            ...
            touch.prevX = touch.x = this._view._calcOffsetX(changedTouch.clientX, changedTouch.clientY);
            touch.prevY = touch.y = this._view._calcOffsetY(changedTouch.clientX, changedTouch.clientY);
            touch.dx = 0;
            touch.dy = 0;
          }
        }
