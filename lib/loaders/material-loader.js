  ...
  resl({
    ...
    onDone(data) {
      ...
      if (json.type === 'unlit') {
        ...
        // values
        if (props.color) {
          material.setProperty('color', color4.create(
              props.color[0],
              props.color[1],
              props.color[2],
              props.color[3]
        ...
        if (props.mainTiling) {
          material.setProperty('mainTiling', vec2.create(
              props.mainTiling[0],
              props.mainTiling[1]
            )
          );
        ...
        if (props.mainOffset) {
          material.setProperty('mainOffset', vec2.create(
              props.mainOffset[0],
              props.mainOffset[1]
            )
          );
        ...
        if (props.diffuseColor) {
          material.setProperty('diffuseColor', color4.create(
        ...
        if (props.specularColor) {
          material.setProperty('specularColor', color4.create(
        ...
        if (props.emissiveColor) {
          material.setProperty('emissiveColor', color3.create(
        ...
        material.setProperty('tiling', vec2.create(props.tilingX, props.tilingY));
        material.setProperty('baseColorBlack', color4.create(
        ...
        material.setProperty('baseColorWhite', color4.create(
        ...
        material.setProperty('subPatternColor', color4.create(
        ...
        material.setProperty('subPatternColor2', color4.create(
        ...
        material.setProperty('basePatternTiling', vec2.create(
            props.basePatternTiling[0],
            props.basePatternTiling[1]
          )
        );
        material.setProperty('basePatternOffset', vec2.create(
            props.basePatternOffset[0],
            props.basePatternOffset[1]
          )
        );

        material.setProperty('subPatternTiling', vec2.create(
            props.subPatternTiling[0],
            props.subPatternTiling[1]
          )
        );
        material.setProperty('subPatternOffset', vec2.create(
            props.subPatternOffset[0],
            props.subPatternOffset[1]
          )
        );

        material.setProperty('subPattern2Tiling', vec2.create(
            props.subPattern2Tiling[0],
            props.subPattern2Tiling[1]
          )
        );
        material.setProperty('subPattern2Offset', vec2.create(
        ...
        material.setProperty('albedo', color4.create(
            props.albedo[0],
            props.albedo[1],
            props.albedo[2],
            props.albedo[3]
        ...
        material.define('USE_EMISSIVE', props.USE_EMISSIVE);
        if (props.emissive) {
          material.setProperty('emissive', color3.create(
              props.emissive[0],
              props.emissive[1],
              props.emissive[2]
            )
        ...
        // values
        if (props.tintColor) {
          material.setProperty('tintColor', color4.create(
              props.tintColor[0],
              props.tintColor[1],
              props.tintColor[2],
              props.tintColor[3]
