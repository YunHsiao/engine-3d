...
export default class AnimatorComponent extends Component {
  ...
  update(dt) {
    ...
    this._animationGraph._subgraphs.forEach((subgraph) => {
      let blendTask = subgraph._switchTask;
      ...
      for (let i = 0; i < blendTask.animationCount; ++i) {
        ...
        blendItem.clip.blendedSample(this._samplingState, motionTime, blendItem.weight * weightCoff, subgraph.mask);
      }
