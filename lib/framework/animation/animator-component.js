...
export default class AnimatorComponent extends Component {
  ...
  update(dt) {
    ...
    this._animationGraph._layers.forEach((layer) => {
      let blendTask = layer._switchTask;
      ...
      for (let i = 0; i < blendTask.animationCount; ++i) {
        ...
        blendItem.clip.blendedSample(this._samplingState, motionTime, blendItem.weight * weightCoff, layer.mask);
      }
    });
