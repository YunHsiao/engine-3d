...
export class AnimationLayer {
  ...
  /**
   *  Get mask of this animation layer.
   * @type {?SkeletonMask}
   */
  get mask() {
    return this._mask;
  ...
  /**
   * Set mask of this animation layer.
   */
  set mask(value) {
    this._mask = value;
  }
...
export class AnimationGraph {
   ...
   * @param {string} name Name of the main animation layer/
   */
  constructor(name = "Main") {
     ...
     * @ignore
     */
    this._mainLayer = new AnimationLayer(name);
  ...
  /**
   * Add a new animation layer into this graph.
   * @param {string} name Name of the new animation layer.
   * @return {AnimationLayer}
   */
  createLayer(name) {
    let result = new AnimationLayer(name);
