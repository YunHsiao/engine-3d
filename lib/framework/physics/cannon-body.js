...
export default class CannonBody extends CANNON.Body {
  ...
  constructor(options) {
    ...
    this._manualUpdate(this._updateRotation, false);
    ...
    this._pull = () => {
      this._manualUpdate(this._updateRotation);
    };
