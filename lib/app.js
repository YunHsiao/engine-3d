...
import ComplexAnimationSystem from './framework/animation/complex-animation-system';
import ComplexAnimationComponent from './framework/animation/complex-animation-component';
...
registry.registerClass('ComplexAnimation', ComplexAnimationComponent);
...
registry.registerSystem('complex-animation', ComplexAnimationSystem, 'ComplexAnimation', 199);
...
export default class App extends AppBase {
  constructor(canvas, opts = {}) {
    ...
    this._input = new Input(this._view, {
      lock: false,
      invertY: true,
    });
