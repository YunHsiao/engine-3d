(() => {
  ...
  entEditor.transitionColors.normal = color4.create(1, 1, 1, 1);
  entEditor.transitionColors.highlight = color4.create(0.3, 1, 1, 1);
  entEditor.transitionColors.pressed = color4.create(0.8, 0.8, 0.8, 1);
  entEditor.transitionColors.disabled = color4.create(0.2, 0.2, 0.2, 1);
  ...
  placeHolderComp.color = color4.create(0, 0, 0, 0.5);
  ...
  inputTextComp.color = color4.create(0, 0, 0, 1);
