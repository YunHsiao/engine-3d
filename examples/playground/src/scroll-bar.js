(() => {
  ...
  // horizontal
  {
    ...
    bgSprite._color = color4.create(1, 1, 1, 1);
    ...
    handleSprite._color = color4.create(0, 1, 1, 1);
    scrollBar.background = handle;
    scrollBar.transition = 'color';
    scrollBar.transitionColors.normal = color4.create(0, 1, 1, 1);
    scrollBar.transitionColors.highlight = color4.create(1, 1, 0, 1);
    scrollBar.transitionColors.pressed = color4.create(0.5, 0.5, 0.5, 1);
    scrollBar.transitionColors.disabled = color4.create(0.2, 0.2, 0.2, 1);
